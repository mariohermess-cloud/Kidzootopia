...
export const ZIELE = [
  ...
  { id:'silbenwissen', fach:'deutsch', titel:'Silben hören & bauen',
    kompetenz:'Wörter in Silben zerlegen, zählen und wieder zusammensetzen.',
    klasse:[1,6], etappe:[1,5], wege:['rhythmus','knobeln','bauen','entdecken','erzaehlen'] },
  ...
  { id:'ernaehrung', fach:'sach',     titel:'Gesund essen',
    kompetenz:'Erkennen, was den Körper stärkt, und warum – ohne Diätregeln oder Verbote.',
    klasse:[1,6], etappe:[1,5], wege:['entdecken','erzaehlen','knobeln','team'] },
  { id:'strandfunde',fach:'sach',     titel:'Strandfunde',
    kompetenz:'Dinge, die man am Strand oder im Watt findet, ihrem Ursprung und ihrer Funktion zuordnen.',
    klasse:[1,6], etappe:[1,5], wege:['entdecken','erzaehlen','knobeln','team'] },
